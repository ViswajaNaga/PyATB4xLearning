...
# How to append - convert to list then append and convert back to tuple
...
tu=(4,5,6)
my_tuple=tu + (9,)
print(my_tuple) # (4, 5, 6, 9)

my_tuple=tu + (7,8)
print(my_tuple) # (4, 5, 6, 7, 8)

env_api_urls=tuple(["dev.com/get","uat.com/post","sit.com/put"])
print(env_api_urls)  # ('dev.com/get', 'uat.com/post', 'sit.com/put')